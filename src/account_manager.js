...
// @grant        GM_addStyle
// @downloadURL https://raw.githubusercontent.com/lijunjie2232/zlib_account_manager/refs/heads/master/src/account_manager.js
// @updateURL https://raw.githubusercontent.com/lijunjie2232/zlib_account_manager/refs/heads/master/src/account_manager.js
// ==/UserScript==
...
(function () {
  ...
  const renderAccountManager = () => {
    ...
    <div style="margin-top: 15px; padding-top: 10px; border-top: 1px solid #eee;">
      ...
      <button class="zlib-btn zlib-btn-primary" id="zlib-export-settings">Export</button>
      <button class="zlib-btn zlib-btn-primary" id="zlib-import-settings">Import</button>
      <input type="file" id="zlib-import-file" accept=".json" style="display: none;">
    </div>
  `;
    ...
    document
      .getElementById("zlib-export-settings")
      .addEventListener("click", exportSettings);
    document
      .getElementById("zlib-import-settings")
      .addEventListener("click", () => {
        document.getElementById("zlib-import-file").click();
      });
    document
      .getElementById("zlib-import-file")
  ...
  const exportSettings = () => {
    ...
    const exportFileDefaultName = "zlib_accounts_backup.json";
